...
class character(object):
    ...
    def createPage(self):
        ...
        '''視窗'''
        self.canvas=Canvas(self.page,width=898,height=490,scrollregion=(0,0,1000,scr_len),bd=0,bg='#f9ca7c')
    ...
    def character_data(self,key):
        ...
        explanation_content.set(re_str)
        ...
        text_for_explanation_content.place(x=200,y=450,width=400)
        #右側大圖 圖片大小請設置500*280
        '''右側角色圖示'''
